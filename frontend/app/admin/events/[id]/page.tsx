          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {event.created_by && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{event.created_by.first_name} {event.created_by.last_name}</p>
                </div>
              </div>
            )}
            {event.is_recurring && event.recurrence_pattern && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">Recurrence Pattern</p>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-background border text-foreground rounded-lg p-6 w-full max-w-md z-50 max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {formData.is_recurring && (
              <div>
                <Label htmlFor="recurrence_pattern">Recurrence Pattern (Optional)</Label>
                <Input
